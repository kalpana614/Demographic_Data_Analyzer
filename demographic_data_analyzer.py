...
def calculate_demographic_data(print_data=True):
    ...
    total_educated = len(df)
    percentage_bachelors = round(num_bachelors/total_educated*100,1)
    ...
    rich_indians= indians["occupation"].value_counts()
    
    top_IN_occupation = rich_indians.idxmax()
